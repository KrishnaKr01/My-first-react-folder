  ...
  return (
    <div className='parent'>
      {jobOpenings.map(function(elem,idx){
        ...
        return <div key={idx}>
          <Card company={elem.companyName}  post={elem.post} tag1={elem.tag1} pay={elem.pay} tag2={elem.tag2} location={elem.location} brandLogo={elem.brandLogo} datePosted={elem.datePosted}/>
        </div>
      })}
